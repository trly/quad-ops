...
// TestBuildVolume_ExplicitNameTakesPriority tests that an explicit name from
// compose takes priority over the auto-generated unit base name.
func TestBuildVolume_ExplicitNameTakesPriority(t *testing.T) {
	vol := &types.VolumeConfig{
...
// TestBuildVolume_AutoGeneratedNameUsesUnitBaseName tests that compose-go's
// auto-generated underscore name is replaced with the dash-separated unit base name.
func TestBuildVolume_AutoGeneratedNameUsesUnitBaseName(t *testing.T) {
	vol := &types.VolumeConfig{
		Name: "testproject_myvolume",
	}
	unit := BuildVolume("testproject", "myvolume", vol, RepositoryMeta{})
