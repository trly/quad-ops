...
// TestBuildNetwork_ExplicitNameTakesPriority tests that an explicit name from
// compose takes priority over the auto-generated unit base name.
func TestBuildNetwork_ExplicitNameTakesPriority(t *testing.T) {
	net := &types.NetworkConfig{
...
// TestBuildNetwork_AutoGeneratedNameUsesUnitBaseName tests that compose-go's
// auto-generated underscore name is replaced with the dash-separated unit base name.
func TestBuildNetwork_AutoGeneratedNameUsesUnitBaseName(t *testing.T) {
	net := &types.NetworkConfig{
		Name: "testproject_mynetwork",
	}
	unit := BuildNetwork("testproject", "mynetwork", net, RepositoryMeta{})
