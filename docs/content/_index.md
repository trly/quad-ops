...
A lightweight GitOps framework for deploying podman containers, running under systemd, with [Quadlet](https://docs.podman.io/en/latest/markdown/podman-systemd.unit.5.html)
